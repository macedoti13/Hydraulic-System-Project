...
MODEL_WITH_WEATHER_SAVING_PATH = os.path.join(os.path.dirname(__file__), "../../models/weather/xgb_weather_22h.pkl")
MODEL_SAVING_PATH = os.path.join(os.path.dirname(__file__), "../../models/no_weather/xgb_22h.pkl")
...
def main():
    ...
    # train the models
    xgb_with_weather = train_xgb_model(df, with_weather=True, target='target_22')
    xgb_without_weather = train_xgb_model(df, with_weather=False, target='target_22')
