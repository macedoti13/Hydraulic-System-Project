...
def generate_question_6_plots(question_6_dataset):
    ...
    fig1.update_layout(title=f'Correlação entre Temperatura do Ar e Consumo de Água (r={correlation_air_temp:.2f})', xaxis_title='Temperatura do Ar (°C)', yaxis_title='Consumo de Água (L/s)')
    ...
    fig2.update_layout(title=f'Correlação entre Precipitacao e Consumo de Água (r={correlation_air_temp:.2f})', xaxis_title='Precipitacao (mm)', yaxis_title='Consumo de Água (L/s)')
    ...
    fig3.update_layout(title=f'Correlação entre Humidade Relativa e Consumo de Água (r={correlation_air_temp:.2f})', xaxis_title='Humidade Relativa (%)', yaxis_title='Consumo de Água (L/s)')
